...
#Atributos Onready
onready var boton_pantalla_completa: CheckBox= $ContenedorTabulador/AudioGraficos/PanelPrincipal/ContenedorPrincipal/CheckBox

onready var opcion_resoluciones= $ContenedorTabulador/AudioGraficos/PanelPrincipal/ContenedorPrincipal/HBoxContainer/OptionButton
...
onready var bus_etiquetas:={
	"Master": $ContenedorTabulador/AudioGraficos/PanelPrincipal/ContenedorPrincipal/VolumenGeneral/Label3,
	"Musica": $ContenedorTabulador/AudioGraficos/PanelPrincipal/ContenedorPrincipal/VolumenMusica/Label3,
	"SFX": $ContenedorTabulador/AudioGraficos/PanelPrincipal/ContenedorPrincipal/VolumenSFX/Label3
}
...
func cargar_volumen_buses ()->void:
	for bus_indice in bus_indices.values():
		...
		var texto_volumne:String = "%01d" % (volumen_actual + 50)
		bus_etiquetas[nombre_bus].text = texto_volumne
...
func _on_OptionButton_item_selected(indice: int)-> void:
